...
function renderCommitteeEvolution() {
    ...
    var option = {
        title: {
            text: "Evolution of Committees (also called PMCs or Top Level Projects) [ECharts]",
...
function renderLanguageChart() {
    ...
    var option = {
    title: {
        text: 'Language distribution (click on a language to view declared projects using it) [ECharts]',
        textStyle: {
            fontSize: 15
        },
        left: 130
    ...
    var option = {
    title: {
        text: 'Categories (click on a category to view declared projects within it) [ECharts]',
        textStyle: {
            fontSize: 15
        },
        left: 130
